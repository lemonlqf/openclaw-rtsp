var Multi_Client_Module = (function () {
  ...
  return function (Multi_Client_Module) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_GLOBAL_DecPlayInfo")) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_GLOBAL_SetLogLevel")) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_RTSP_SetStreamTimeout")) {
      Object.defineProperty(Module["ready"], "_RTSP_SetStreamTimeout", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _RTSP_SetStreamTimeout on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js",
          );
        },
      });
      Object.defineProperty(Module["ready"], "_RTSP_SetStreamTimeout", {
        ...
        set: function () {
          abort(
            "You are setting _RTSP_SetStreamTimeout on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js",
          );
        },
      });
    }
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_RTSP_SetOriginalKey")) {
      Object.defineProperty(Module["ready"], "_RTSP_SetOriginalKey", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _RTSP_SetOriginalKey on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js",
          );
        },
      });
      Object.defineProperty(Module["ready"], "_RTSP_SetOriginalKey", {
        ...
        set: function () {
          abort(
            "You are setting _RTSP_SetOriginalKey on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js",
          );
        },
      });
    }
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_RTSP_PlayControlUtc")) {
      Object.defineProperty(Module["ready"], "_RTSP_PlayControlUtc", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _RTSP_PlayControlUtc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js",
          );
        },
      });
      Object.defineProperty(Module["ready"], "_RTSP_PlayControlUtc", {
        ...
        set: function () {
          abort(
            "You are setting _RTSP_PlayControlUtc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js",
          );
        },
      });
    }
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_RTSV_SetOriginalKey")) {
      Object.defineProperty(Module["ready"], "_RTSV_SetOriginalKey", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _RTSV_SetOriginalKey on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js",
          );
        },
      });
      Object.defineProperty(Module["ready"], "_RTSV_SetOriginalKey", {
        ...
        set: function () {
          abort(
            "You are setting _RTSV_SetOriginalKey on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js",
          );
        },
      });
    }
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_VNSP_InitSession")) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_VNSP_SetLoginParam")) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_VNSP_StartStream")) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_VNSP_PauseStream")) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_VNSP_ResumeStream")) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_VNSP_SetPlayRange")) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module["ready"], "___emscripten_pthread_data_constructor")
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module["ready"], "_emscripten_run_in_main_runtime_thread_js")
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module["ready"], "_emscripten_sync_run_in_main_thread_2")
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module["ready"], "_emscripten_sync_run_in_main_thread_4")
    ) {
    ...
    function _cPlusMediaFrameCallBack(handle, index, data, size) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(15, 1, handle, index, data, size);
    ...
    function _emscripten_set_canvas_element_size_main_thread(target, width, height) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(19, 1, target, width, height);
    ...
    function _emscripten_websocket_close(socketId, code, reason) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(20, 1, socketId, code, reason);
    ...
    function _emscripten_websocket_send_binary(socketId, binaryData, dataLength) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(24, 1, socketId, binaryData, dataLength);
      var socket = WS.sockets[socketId];
      if (!socket) {
        return -3;
      }
    ...
    function _emscripten_websocket_set_onclose_callback_on_thread(
      ...
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(26, 1, socketId, userData, callbackFunc, thread);
    ...
    function _environ_get(__environ, environ_buf) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(30, 1, __environ, environ_buf);
      try {
        var bufSize = 0;
    ...
    function _environ_sizes_get(penviron_count, penviron_buf_size) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(31, 1, penviron_count, penviron_buf_size);
      try {
    ...
    function _fd_fdstat_get(fd, pbuf) {
      if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(33, 1, fd, pbuf);
      try {
        var stream = SYSCALLS.getStreamFromFD(fd);
    ...
    function _sysconf(name) {
      if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(39, 1, name);
      switch (name) {
        case 30:
          return 16384;
        case 85:
    ...
    var _RTSP_PlayControlUtc = (Module["_RTSP_PlayControlUtc"] =
      createExportWrapper("RTSP_PlayControlUtc"));
    ...
    var _RTSP_SetStreamTimeout = (Module["_RTSP_SetStreamTimeout"] =
      createExportWrapper("RTSP_SetStreamTimeout"));
    var _RTSP_SetOriginalKey = (Module["_RTSP_SetOriginalKey"] =
      createExportWrapper("RTSP_SetOriginalKey"));
    ...
    var _RTSV_SetOriginalKey = (Module["_RTSV_SetOriginalKey"] =
      createExportWrapper("RTSV_SetOriginalKey"));
    var _GLOBAL_DecPlayInfo = (Module["_GLOBAL_DecPlayInfo"] =
      createExportWrapper("GLOBAL_DecPlayInfo"));
    var _VNSP_InitSession = (Module["_VNSP_InitSession"] = createExportWrapper("VNSP_InitSession"));
    var _VNSP_SetLoginParam = (Module["_VNSP_SetLoginParam"] =
      createExportWrapper("VNSP_SetLoginParam"));
    var _VNSP_StartStream = (Module["_VNSP_StartStream"] = createExportWrapper("VNSP_StartStream"));
    var _VNSP_StopStream = (Module["_VNSP_StopStream"] = createExportWrapper("VNSP_StopStream"));
    var _VNSP_PauseStream = (Module["_VNSP_PauseStream"] = createExportWrapper("VNSP_PauseStream"));
    ...
    var _VNSP_FastPlay = (Module["_VNSP_FastPlay"] = createExportWrapper("VNSP_FastPlay"));
    var _VNSP_PutStream = (Module["_VNSP_PutStream"] = createExportWrapper("VNSP_PutStream"));
    ...
    var dynCall_iijjffiii = (Module["dynCall_iijjffiii"] =
      createExportWrapper("dynCall_iijjffiii"));
    var dynCall_iiijjffiiii = (Module["dynCall_iiijjffiiii"] =
      createExportWrapper("dynCall_iiijjffiiii"));
    ...
    var __emscripten_main_thread_futex = (Module["__emscripten_main_thread_futex"] = 715408);
