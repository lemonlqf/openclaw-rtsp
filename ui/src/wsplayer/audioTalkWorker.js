    ...
    var a = function () {
        ...
        return (
          (l.prototype = {
            ...
            encode: function (e) {
              var r = null;
              (null !== i
                ? ((r = new Float32Array(e.length + i.length)).set(i, 0), r.set(e, i.length))
                : (r = e),
                (r = (function (e, r) {
                  if (r === t) return e;
                  r > t && n.log("The rate of device show be smaller than local sample rate");
                  for (
                    var a = t / r,
                    ...
                    for (
                      var f = Math.round((l + 1) * a), c = 0, h = 0, g = s, T = e.length;
                      g < f && g < T;
                      g++
                    )
                      ((c += e[g]), h++);
              ...
              for (
                var a = new Int16Array(r.length), l = new Uint8Array(a.length), s = 0, f = r.length;
                s < f;
                s++
              )
      ...
      o = function (t) {
        ...
        function f(t, e, r) {
          var n = [],
            a = e || 4;
          if (!0 === r) for (var o = 0; o < a; o++) n[o] = (t >>> (8 * (a - 1 - o))) & 255;
        ...
        return (
          (c.prototype = {
            ...
            getRTPPacket: function (a) {
              var c = r.encode(a),
                h = 0;
              ((e = new Uint8Array(n.length + 40 + c.length + 8)).set([36, t], h),
                (h += 2),
